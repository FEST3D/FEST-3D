...
ShowAllWindows()
OpenDatabase("./output*.vtk database", 0)
# The UpdateDBPluginInfo RPC is not supported in the VisIt module so it will not be logged.
metadata = GetMetaData("./output*.vtk database", -1)
DefineScalarExpression("Mach_No", "Velocity_magnitude/(sqrt(1.4*Pressure/Density))")
AddPlot("Pseudocolor", "Mach_No", 1, 1)
