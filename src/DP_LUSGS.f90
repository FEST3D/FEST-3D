...
#include "mpi.inc"
  ...
  public :: update_with_DP_LUSGS
  public :: setup_DP_LUSGS
  public :: destroy_DP_LUSGS

  contains

    subroutine setup_DP_LUSGS()
      implicit none
    ...
    end subroutine setup_DP_LUSGS

    subroutine destroy_DP_LUSGS()
      implicit none
      ...
      call dealloc(dummy)
    end subroutine destroy_DP_LUSGS

    subroutine update_with_DP_LUSGS()
      implicit none
    ...
    end subroutine update_with_DP_LUSGS
...
!    end function SSTFlux
    ...
    subroutine update_SST_variables()
      ...
      integer :: i,j,k, SubIter
        ...
        real, dimension(1:7)     :: LOldIminusFlux
        real, dimension(1:7)     :: LOldJminusFlux
        real, dimension(1:7)     :: LOldKminusFlux
        real, dimension(1:7)     :: LNewIminusFlux
        real, dimension(1:7)     :: LNewJminusFlux
        real, dimension(1:7)     :: LNewKminusFlux
        real, dimension(1:7)     :: LDelIminusFlux
        real, dimension(1:7)     :: LDelJminusFlux
        real, dimension(1:7)     :: LDelKminusFlux
        real, dimension(1:7)     :: UOldIminusFlux
        real, dimension(1:7)     :: UOldJminusFlux
        real, dimension(1:7)     :: UOldKminusFlux
        real, dimension(1:7)     :: UNewIminusFlux
        real, dimension(1:7)     :: UNewJminusFlux
        real, dimension(1:7)     :: UNewKminusFlux
        real, dimension(1:7)     :: UDelIminusFlux
        real, dimension(1:7)     :: UDelJminusFlux
        real, dimension(1:7)     :: UDelKminusFlux
        real, dimension(1:6)     :: LambdaTimesArea
        ...
        do k=kmx-1,1,-1
              ...
              delQ(i,j,k,1:7) = (-residue(i,j,k,1:7) &
                - 0.5*((LDelIminusFlux + UDelIminusFlux) &
                     + (LDelJminusFlux + UDelJminusFlux) &
                     + (LDelKminusFlux + UDelKminusFlux)))/D
    ...
    subroutine update_SA_variables()
      ...
      integer :: i,j,k, SubIter
        ...
        real, dimension(1:6)     :: LOldIminusFlux
        real, dimension(1:6)     :: LOldJminusFlux
        real, dimension(1:6)     :: LOldKminusFlux
        real, dimension(1:6)     :: LNewIminusFlux
        real, dimension(1:6)     :: LNewJminusFlux
        real, dimension(1:6)     :: LNewKminusFlux
        real, dimension(1:6)     :: LDelIminusFlux
        real, dimension(1:6)     :: LDelJminusFlux
        real, dimension(1:6)     :: LDelKminusFlux
        real, dimension(1:6)     :: UOldIminusFlux
        real, dimension(1:6)     :: UOldJminusFlux
        real, dimension(1:6)     :: UOldKminusFlux
        real, dimension(1:6)     :: UNewIminusFlux
        real, dimension(1:6)     :: UNewJminusFlux
        real, dimension(1:6)     :: UNewKminusFlux
        real, dimension(1:6)     :: UDelIminusFlux
        real, dimension(1:6)     :: UDelJminusFlux
        real, dimension(1:6)     :: UDelKminusFlux
        real, dimension(1:6)     :: LambdaTimesArea
