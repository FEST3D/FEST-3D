      ...
      select case (face)
        ...
        case('jmax')
          do k = 1,kmx-1
            do j = jmx,jmx
              do i = 1,imx-1
                c_x  = xA(i,j,k)*xnx(i,j,k)/volume(i,j-1,k)
                c_y  = xA(i,j,k)*xny(i,j,k)/volume(i,j-1,k)
                c_z  = xA(i,j,k)*xnz(i,j,k)/volume(i,j-1,k)
        ...
        case('kmax')
          do k = kmx,kmx
            do j = 1,jmx-1
              do i = 1,imx-1
                c_x  = xA(i,j,k)*xnx(i,j,k)/volume(i,j,k-1)
                c_y  = xA(i,j,k)*xny(i,j,k)/volume(i,j,k-1)
                c_z  = xA(i,j,k)*xnz(i,j,k)/volume(i,j,k-1)
