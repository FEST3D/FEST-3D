...
#include "mpi.inc"
  ...
  public :: update_with_GMRES
  public :: setup_GMRES
  public :: destroy_GMRES

  contains

    subroutine setup_GMRES()
      implicit none
      character(len=*), parameter :: &
        errmsg="module: GMRES, subrouinte setup"
      ...
      allocate(w(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))
      allocate(z(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))
      allocate(g(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))
      allocate(sn(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))
      allocate(cn(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))
      allocate(y(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))
      allocate(H(1:imx-1,1:jmx-1,1:kmx-1,1:n_var,1:m))

    end subroutine setup_GMRES

    subroutine destroy_GMRES()
      implicit none
      ...
      deallocate(y)
      deallocate(H)
    end subroutine destroy_GMRES

    subroutine update_with_GMRES()
      implicit none
    ...
    end subroutine update_with_GMRES
...
!
    ...
    subroutine update_laminar_variables(delQ, residue)
      implicit none
      real, dimension(:,:,:,:), intent(in) :: residue
      real, dimension(:,:,:,:), intent(out) :: delQ
