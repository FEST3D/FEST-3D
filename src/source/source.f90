...
!            include "turbulence_models/include/source/gradient_find.inc"
        ...
        ! right ghost cells
        gradu_x(imx,:,:) = gradu_x(imx-1,:,:)
        gradv_x(imx,:,:) = gradv_x(imx-1,:,:)
        gradw_x(imx,:,:) = gradv_x(imx-1,:,:)
        gradu_y(imx,:,:) = gradu_y(imx-1,:,:)
        gradv_y(imx,:,:) = gradv_y(imx-1,:,:)
        gradw_y(imx,:,:) = gradv_y(imx-1,:,:)
        gradu_z(imx,:,:) = gradu_z(imx-1,:,:)
        gradv_z(imx,:,:) = gradv_z(imx-1,:,:)
        gradw_z(imx,:,:) = gradv_z(imx-1,:,:)
        ...
        ! top ghost cells
        gradu_x(:,jmx,:) = -gradu_x(:,jmx-1,:)
        gradv_x(:,jmx,:) = -gradv_x(:,jmx-1,:)
        gradw_x(:,jmx,:) = -gradv_x(:,jmx-1,:)
        gradu_y(:,jmx,:) = -gradu_y(:,jmx-1,:)
        gradv_y(:,jmx,:) = -gradv_y(:,jmx-1,:)
        gradw_y(:,jmx,:) = -gradv_y(:,jmx-1,:)
        gradu_z(:,jmx,:) = -gradu_z(:,jmx-1,:)
        gradv_z(:,jmx,:) = -gradv_z(:,jmx-1,:)
        gradw_z(:,jmx,:) = -gradv_z(:,jmx-1,:)
        ...
        ! back ghost cells
        gradu_x(:,:,kmx) = -gradu_x(:,:,kmx-1)
        gradv_x(:,:,kmx) = -gradv_x(:,:,kmx-1)
        gradw_x(:,:,kmx) = -gradv_x(:,:,kmx-1)
        gradu_y(:,:,kmx) = -gradu_y(:,:,kmx-1)
        gradv_y(:,:,kmx) = -gradv_y(:,:,kmx-1)
        gradw_y(:,:,kmx) = -gradv_y(:,:,kmx-1)
        gradu_z(:,:,kmx) = -gradu_z(:,:,kmx-1)
        gradv_z(:,:,kmx) = -gradv_z(:,:,kmx-1)
        gradw_z(:,:,kmx) = -gradv_z(:,:,kmx-1)
        ...
        ! right ghost cells
        gradT_x(imx,:,:) = -gradT_x(imx-1,:,:)
        gradT_y(imx,:,:) = -gradT_y(imx-1,:,:)
        gradT_z(imx,:,:) = -gradT_z(imx-1,:,:)
        ...
        ! toT ghost cells
        gradT_x(:,jmx,:) = -gradT_x(:,jmx-1,:)
        gradT_y(:,jmx,:) = -gradT_y(:,jmx-1,:)
        gradT_z(:,jmx,:) = -gradT_z(:,jmx-1,:)
        ...
        ! baTk ghost cells
        gradT_x(:,:,kmx) = -gradT_x(:,:,kmx-1)
        gradT_y(:,:,kmx) = -gradT_y(:,:,kmx-1)
        gradT_z(:,:,kmx) = -gradT_z(:,:,kmx-1)
